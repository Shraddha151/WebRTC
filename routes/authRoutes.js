...
router.post("/login", async (req, res) => {
  ...
  try {
    ...
    // Generate JWT
    const token = jwt.sign({ id: user._id, username: user.username, email: user.email, city: user.city }, "mongodb+srv://shraddhabhab955@gmail.com:<Spbhat151@>@cluster0.3erwj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", { expiresIn: "1h" });
